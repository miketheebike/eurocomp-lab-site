...
To achieve greater productivity and to address a growing competitiveness gap with other leading economies, Europe must undergo a radical transformation. This gap, particularly compared with the United States and China, has been increasingly evident. In 2021, for instance, EU companies have spent about half as much on Research and Innovation (R&I) as a share of Gross Domestic Product (GDP) as US companies, around €270 billion. Increased funding alone will not close this gap.
...
## What Cohesion Policy is, and why funding alone is not enough
...
A prime example of this challenge is the EU's inefficient use of funds, reflected in low absorption rates. Almost halfway through the RRF implementation period, by the end of 2023, the European Commission had disbursed only around a third of the funds, €213 billion of the €723.8 billion, to Member States (European Court of Auditors, 2024).
...
## What we do not know about Cohesion Policy's impact
...
Experimental policy learning that relies on randomised controlled trials (RCTs) and other rigorous evaluation methods, followed by adequate stock-taking of what works, can help fill the current learning and policy innovation gap in Cohesion Policy's competitiveness programmes. In the same way that companies invest in Research and Development (R&D) to identify the most successful products to scale up, evaluations can help identify novel interventions and the conditions under which the returns to current investments can be maximised.
...
The World Bank focuses on analytical and advisory work; implementation remains the responsibility of Member States. Wherever possible, impacts are assessed at sub-regional level, for example comparing capital cities with other regions, reflecting a clear mandate of DG REGIO's focus under Cohesion Policy.

## Four workstreams, one goal
...
A phased approach ensures that each segment of the project is independently viable, while contributing to the long-term goal of establishing the EuroCOMP Lab. The two phases are interconnected, and both contribute to developing the basis for the EuroCOMP Lab, but each has sufficient independence on its own.
...
:::
::: {.body}
Funding has been confirmed and secured. The deliverables and costs set out in the concept note relate only to Phase A, which has been agreed with DG REGIO and will be channelled through a new standalone trust fund under the EU2020 Programmatic Trust Fund.
:::
:::
::: {.col-e}
::: {.col-head}
...
:::
::: {.body}
The additional contribution is conditional on budget availability, and will be confirmed in 2025.
:::
:::
:::

With this process, the project will help create a de facto EuroCOMP Lab, which will be institutionalised and developed further in future programmes.
